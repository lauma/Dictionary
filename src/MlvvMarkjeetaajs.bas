...
Sub Izrunas()
    ...
    With oRange.Find
        ...
        .Replacement.text = "<e-circumflex-wide/>"
        .Forward = True
        .Wrap = wdFindContinue
        .Format = True
        .MatchCase = True
