...
public class OptHypernRules
{
	...
	public static final Rule[] directFirstConjVerb = {
		...
		FirstConjRule.direct("-šmuku, -šmūc,", "-šmūc, pag. -šmuku", "šmukt"), //iešmukt
	...
	public static final Rule[] reflFirstConjVerb = {
		...
		FirstConjRule.refl("-krītos, -krities,", "-krītas, pag. -kritos", "kristies"), //izkristies
		...
		FirstConjRule.refl("-maļos, -malies,", "-maļas, pag. -mālos", "malties"), //apmalties
			// TODO -maļos, -malies, -maļas, pag. -malos
		...
		FirstConjRule.refl("-traušos, -trausies,", "-trausās, pag. -trausos", "trausties"), //ietrausties
